...
class Index extends Component
{
	constructor() {
		...
		this.state = {
			users     : [
				{id : 11, orderdate : "10/25/2022", from : " Nairobi", to : "Machakos", status :"Pending"},
      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
			        ...
			        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal"> Add Order </button>
			    </div>
